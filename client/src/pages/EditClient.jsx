...
export default function EditClient() {
  ...
  const [formData,setFormData] = useState({name:'',weight:'',no_pieces:'',phone:''});
  ...
  return (
    ...
    <h3 className='mt-4  text-5xl'>EDIT CLIENT</h3>
      ...
      <form className='flex flex-col w-[500px] P-4' onSubmit={handleSubmit}  >
        ...
        <div className='flex flex-col gap-4'>
          ...
          <input type="text" placeholder="client name" id='name' value={formData.name} className='border p-3 rounded-lg'
          ...
          <label className='mb-4 text-1xl font-semibold'>Phone No.</label>
            <input type="text" placeholder="phone" id='phone' value={formData.phone}  className='border p-3 rounded-lg'
            required onChange={handleChange}
          />
